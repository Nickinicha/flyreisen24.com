...
(function () {
  ...
  function ensureGlobalNavbarMarkup() {
    ...
    const hasCanonicalStructure =
      ...
      menu.querySelector("#navResources");
  ...
  const translations = {
    th: {
      ...
      cardFlightDesc:
        "เปรียบเทียบราคาจากสายการบินทั่วโลก รับดีลที่ดีที่สุดสำหรับทริปถัดไปของคุณ",
      btnFlight: "จองเที่ยวบิน",
      cardHotelTitle: "โรงแรม & ที่พัก",
      cardHotelDesc:
        "โรงแรม รีสอร์ท และที่พักคุณภาพกว่า 1.4 ล้านแห่ง ในราคาพิเศษเฉพาะคุณ",
      btnHotel: "ดูที่พัก",
      cardDealsTitle: "ดีลการเดินทาง",
      cardDealsDesc:
        "เที่ยวบิน · โรงแรม · กิจกรรม · รถรับส่งสนามบิน · รถเช่า — ครบทุกบริการ เปรียบเทียบง่าย จองได้เลย",
      btnDeals: "ดูดีลทั้งหมด",
      featuresTitle: "ทำไมต้องเลือกเรา",
      feature1Title: "เปรียบเทียบราคา",
      feature1Desc:
        "ค้นหาและเปรียบเทียบราคาตั๋วเครื่องบินจากสายการบินชั้นนำทั่วโลก",
      ...
      footerDesc:
        "แพลตฟอร์มค้นหาการเดินทางที่คุ้มค่าที่สุด รวบรวมดีลจากพาร์ทเนอร์ชั้นนำทั่วโลกมาไว้ในที่เดียว",
      ...
      heroTitle:
        'จองเที่ยวบิน + โรงแรม + ดีล<br><span class="hero-highlight">ในที่เดียว</span>',
      heroSubtitle:
        "เปรียบเทียบราคาจากสายการบิน โรงแรม และบริการรถเช่าชั้นนำทั่วโลก — ได้ดีลที่ดีที่สุด ไม่มีค่าธรรมเนียมซ่อน",
    },
    en: {
      ...
      cardFlightDesc:
        "Compare prices from airlines worldwide and get the best deals for your next trip",
      btnFlight: "Book Flights",
      cardHotelTitle: "Hotels & Accommodations",
      cardHotelDesc:
        "Over 1.4 million quality hotels, resorts, and accommodations at special prices",
      btnHotel: "View Hotels",
      cardDealsTitle: "Travel Deals",
      cardDealsDesc:
        "Flights · Hotels · Activities · Airport Transfers · Car Rentals — all in one place",
      btnDeals: "View All Deals",
      featuresTitle: "Why Choose Us",
      feature1Title: "Compare Prices",
      feature1Desc:
        "Search and compare flight prices from top airlines worldwide",
      feature2Title: "No Hidden Fees",
      feature2Desc:
        "Transparent every step — the price shown is the real price you pay",
      ...
      footerDesc:
        "The most valuable travel search platform, bringing together deals from world-class partners in one place",
      ...
      heroBadge:
        "✈️ Ground staff perspective — from behind the check-in counter",
      heroTitle:
        'Book Flights + Hotels + Deals<br><span class="hero-highlight">in One Place</span>',
      heroSubtitle:
        "Compare prices from top airlines, hotels, and car rental services worldwide — best deals, no hidden fees",
    },
    de: {
      navServices: "Services",
      ...
      cardFlightDesc:
        "Vergleichen Sie Preise von Airlines weltweit und erhalten Sie die besten Angebote",
      btnFlight: "Flüge buchen",
      cardHotelTitle: "Hotels & Unterkünfte",
      cardHotelDesc:
        "Über 1,4 Millionen Hotels, Resorts und Unterkünfte zu Sonderpreisen",
      btnHotel: "Hotels ansehen",
      cardDealsTitle: "Reiseangebote",
      cardDealsDesc:
        "Flüge · Hotels · Aktivitäten · Flughafentransfer · Mietwagen — alles an einem Ort",
      btnDeals: "Alle Angebote",
      featuresTitle: "Warum uns wählen",
      feature1Title: "Preise vergleichen",
      feature1Desc:
        "Suchen und vergleichen Sie Flugpreise von Top-Airlines weltweit",
      feature2Title: "Keine versteckten Gebühren",
      feature2Desc:
        "Transparent bei jedem Schritt — der angezeigte Preis ist der echte Preis",
      feature3Title: "Hohe Zuverlässigkeit",
      feature3Desc:
        "Mit vertrauenswürdigen Partnern, die Ihre Sicherheit garantieren",
      ...
      footerDesc:
        "Die wertvollste Reisesuchplattform, die Angebote von Weltklasse-Partnern zusammenbringt",
      ...
      heroBadge:
        "✈️ Perspektive vom Check-in-Schalter — 10+ Jahre Bodenabfertigung",
      heroTitle:
        'Flüge + Hotels + Angebote<br><span class="hero-highlight">an einem Ort</span>',
      heroSubtitle:
        "Preise von Top-Airlines, Hotels und Mietwagen weltweit vergleichen — beste Deals, keine versteckten Gebühren",
    },
  };
  ...
  function getEffectiveLang() {
    // Prefer URL path language (authoritative for content pages), then localStorage, then html lang
    const path = window.location.pathname;
  ...
  /** Pages that share one URL for all languages — switch in-place instead of redirecting */
  function isSharedLanguagePage(path) {
  ...
  function syncAllWidgets(langCode) {
    ...
    const onSmartSearch =
      window.location.pathname.indexOf("smart-search") !== -1;
  ...
  function switchLanguage(langCode, label) {
    if (langCode !== "th" && langCode !== "en" && langCode !== "de") {
      langCode = "th";
    }
    const labelMap = { th: "TH", en: "EN", de: "DE" };
    label = label || labelMap[langCode] || "TH";

    const path = window.location.pathname;
    const shared = isSharedLanguagePage(path);

    // Always persist choice first
    ...
    // Shared pages (home, tools, contact, deals, booking): update UI in place
    if (shared) {
    ...
    // Content pages with language-specific HTML (FAQ, about, terms, privacy): navigate
    ...
    if (
      targetUrl &&
      targetUrl !== path &&
      targetUrl !== path + window.location.search + window.location.hash
    ) {
      window.location.href = targetUrl;
      return;
    }
    if (PAGE_MAPPINGS[currentPage] && PAGE_MAPPINGS[currentPage][langCode]) {
      const mapped = PAGE_MAPPINGS[currentPage][langCode];
      if (mapped !== path) {
    ...
    // Fallback: stay on page but still refresh UI strings + widgets
    updateContent(langCode);
    updateNavigationLinks(langCode);
    syncAllWidgets(langCode);
    updateLanguageDropdownHrefs();
  ...
  function closeAllNavDropdowns() {
    document
      .querySelectorAll("nav.top-nav li.dropdown-active")
      .forEach((item) => {
    ...
    document.addEventListener(
      ...
      function (event) {
        ...
        if (
          ...
          topMenu.classList.contains("active")
        ) {
        ...
        const insideOpenDropdown = event.target.closest(
          "nav.top-nav li.dropdown-active"
        );
        const onAnyDropdownToggle = event.target.closest(
  ...
  function toggleReadMore(btn) {
    ...
    const isHidden =
      fullContent.style.display === "none" || fullContent.style.display === "";
  ...
  function injectFullFaqContentFromLegacy() {
    ...
    for (let i = 0; i < maxCount; i++) {
      const visibleAnswer = visibleItems[i].querySelector(
        ".faq-answer-content"
      );
      ...
      visibleAnswer.innerHTML =
        ...
        '<button class="read-more-btn" type="button" onclick="toggleReadMore(this)">' +
        ui.more +
        "</button>" +
        "</div>" +
  ...
  function initialize() {
    ...
    // Sync localStorage with URL path when on /en/ or /de/ content pages
    const path = window.location.pathname;
    if (path.indexOf("/en/") !== -1) {
      localStorage.setItem("flyreisen24_lang", "en");
    } else if (path.indexOf("/de/") !== -1) {
      localStorage.setItem("flyreisen24_lang", "de");
    } else if (path.indexOf("/th/") !== -1) {
      localStorage.setItem("flyreisen24_lang", "th");
    }
    ...
    document.querySelectorAll(".lang-dropdown-menu a").forEach((link) => {
      ...
      if (
        ...
        link.getAttribute("onclick").includes("'" + currentLang + "'")
      ) {
    ...
    if (form && !form.dataset.listenerAttached) {
      ...
      form.addEventListener("submit", async function (e) {
        ...
        if (submitBtn && t)
          submitBtn.innerHTML =
            '<i class="fas fa-paper-plane"></i> ' + t.btnSubmit;
      });
    }

    console.log(
      "✅ FlyReisen24 common.js initialized | page: " +
        getCurrentPageType() +
        " | lang: " +
        currentLang
    );
...
#feedbackSuccess {
  ...
  function updateFeedbackLang(langCode) {
    ...
    const fbTextarea = document.querySelector(
      '#feedbackForm textarea[name="message"]'
    );
    if (fbTextarea) fbTextarea.placeholder = fbt.detail_placeholder;
    const fbSelect = document.querySelector(
      '#feedbackForm select[name="problem_type"]'
    );
    if (fbSelect) {
    ...
    const langInput = document.querySelector(
      '#feedbackForm input[name="user_lang"]'
    );
  ...
  function initFeedbackWidget() {
    ...
    const currentLang =
      localStorage.getItem("flyreisen24_lang") ||
